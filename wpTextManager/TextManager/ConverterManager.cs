namespace TextManager
{
    ...
    {
        /// <summary>
        /// Gets an integer from its name in letters.
        /// </summary>
        /// <param name="language">Specifies a language.</param>
        /// <param name="strNumberText">Integer number specified in letters.</param>
        /// <returns>Integer number.</returns>
        public static int StringToInteger(Entities.Language language, string strNumberText)
        {
            int intTotalValue = 0;
            ...
            // Case for spanish
            if (language == Entities.Language.Es)
            {
